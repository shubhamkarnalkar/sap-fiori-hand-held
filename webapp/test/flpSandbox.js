					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hand Held Terminal",
									"targetURL": "#handheldd-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"handheldd-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=handheldd",
									"url": sap.ui.require.toUrl("handheldd")
								}
							}
						}
					}
